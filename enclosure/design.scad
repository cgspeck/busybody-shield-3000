...
include <./lib/YAPPgenerator_v3.scad>

echo("leonardoPcbWidth", leonardoPcbWidth);
echo("leonardoPcbLength", leonardoPcbLength);
//---------------------------------------------------------
// This design is parameterized based on the size of a PCB.
//---------------------------------------------------------
...
echo("leonardoPcbLength2", leonardoPcbLength);
// ********************************************************************
...
pcbLength           = leonardoPcbLength; // front to back (X axis)

pcbWidth            = leonardoPcbWidth; // side to side (Y axis)
pcbThickness        = leonardoPcbThickness; 
standoffHeight      = 8-leonardoPcbThickness+0.5; //1.0; //-- How much the PCB needs to be raised from the base to leave room for solderings and whatnot
...
cutoutsBack =   [
  [ // microUsb
    ...
    microUsbPlugYOffset - connectorTolerance - 3,
    microUsbPlugWidth + 2*connectorTolerance,
    microUsbPlugHeight + 2*connectorTolerance + 3,
    0,
    yappRectangle
  ],
